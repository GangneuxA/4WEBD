 ...
 *     responses:
 *       '200':
 *         description: Succès de la connexion. Retourne les détails de l'utilisateur connecté.
 *         content:
 *           application/json:
 *             schema:
 *               type: object
 ...
 *                   example: true
 *       '401':
 *         description: Identifiants invalides. L'utilisateur n'a pas été trouvé ou le mot de passe est incorrect.
 *         content:
 *           application/json:
 *             schema:
 *               type: object
 ...
 *                   type: string
 *       '500':
 *         description: Une erreur s'est produite lors de la connexion de l'utilisateur.
 *         content:
 *           application/json:
 *             schema:
 *               type: object
